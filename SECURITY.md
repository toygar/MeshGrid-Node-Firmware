...
MeshGrid-Node is currently in early-stage development. Security fixes, when issued, are applied only to the latest public release unless explicitly stated otherwise.
...
- **Alternative contact:** `<your-security-email@example.com>`
...
- Once a fix is available, we may publish a security advisory and update guidance for affected users

### Scope

This policy applies to security issues such as, but not limited to:

- vulnerabilities that weaken confidentiality or integrity of mesh communications
